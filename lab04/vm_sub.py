...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jrawad/ipinfo")
    client.subscribe("jrawad/date")
    client.subscribe("jrawad/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jrawad/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("jrawad/date", on_message_from_date)
    client.message_callback_add("jrawad/time", on_message_from_time)
