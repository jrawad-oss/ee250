...
def get_inbox(recipient: str) -> None:
    ...
    Retrieves all mail messages sent to a recipient by making a GET request to the /mail/inbox/{recipient} endpoint. 
    
    Args:
        recipient (str): The recipient of the mail whose messages are being retrieved
...
def get_sent(sender: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves all mail messages sent by the sender by making a GET request to the /mail/sent/{sender} endpoint.

    Args:
        sender (str): The sender of the mail whose messages are being retrieved
...
def get_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves a mail entry using the mail ID by making a GET request to the /mail/{mail_id} endpoint.
...
def delete_mail(mail_id: str) -> None:
    ...
    Args:
        mail_id (str): The unique ID assigned to the mail entry being deleted
